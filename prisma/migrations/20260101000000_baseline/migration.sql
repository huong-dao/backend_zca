...
-- CreateIndex
CREATE UNIQUE INDEX "zalo_groups_global_id_key" ON "zalo_groups"("global_id");
...
-- CreateIndex
CREATE INDEX "zalo_accounts_is_deleted_idx" ON "zalo_accounts"("is_deleted");

-- CreateIndex
CREATE INDEX "zalo_account_groups_group_zalo_id_idx" ON "zalo_account_groups"("group_zalo_id");

-- CreateIndex
CREATE UNIQUE INDEX "zalo_account_groups_zalo_account_id_group_id_key" ON "zalo_account_groups"("zalo_account_id", "group_id");
